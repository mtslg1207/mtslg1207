...
글 번호 : ${recentRead.bbs.num} <br>
제목 : ${recentRead.bbs.title} <br>
내용 : ${recentRead.bbs.contents} <br>
작성자 : ${recentRead.bbs.author} <br>
</div>
<hr>
<div style="border:1px solid black; padding: 10px 10px 10px 10px; margin-right:1000px;">
<h3>업로드된 파일 정보</h3>
...
<a href="edit?num=${recentRead.bbs.num}">[글 수정]</a>
...
<div style="border: 1px dotted black; padding: 10px 10px 10px 10px; margin-right:1000px;" >
	...
	답글 제목 : <input type="text" name="title" value="Re:${recentRead.bbs.title}"><br>
	답글 내용 : <br><textarea name="contents">${recentRead.bbs.contents}</textarea><br>
	답글 작성자 : ${userID}<input type="hidden" name="author" value="${userID}"><br>
